(function () {
  ...
  function Brush() {
    ...
    this.regexList = [
      ...
      { regex: /\b\d+(st|nd|rd|th)\b/g, css: "keyword" },
      {
        regex:
  ...
  typeof require != "undefined"
    ...
    var keyops = "[_:=><%#@]+";
		...
		this.regexList = [
			...
			{ regex: /\b\d+\b/gm,				css: 'number' },			// number
			{ regex: new RegExp(this.getKeywords(keywords), 'gmi'),				css: 'keyword' },			// keyword
			{ regex: new RegExp(this.getKeywords(funcs), 'gmi'),				css: 'functions' },			// functions
			{ regex: new RegExp(this.getKeywords(operators), 'gmi'),			css: 'preprocessor' },			// operators and such
			{ regex: new RegExp(keyops, 'gm'),			css: 'preprocessor' },			// operators and such
			];
	};
  Brush.prototype = new SyntaxHighlighter.Highlighter();
  Brush.aliases = ["sql"];
